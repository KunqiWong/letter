...
<template>
  <div class="AvatarUploader">
    <div>
      ...
      <div v-else class="image">
        ...
        <div class="mask">
          ...
          <el-tooltip effect="dark" content="更换头像" placement="top">
            <i
    ...
    <el-dialog class="header_img" :visible.sync="isVisible_previewAvatarDialog">
      <img width="600" height="600" :src="avatarUrl" />
    </el-dialog>
    <!-- 修改头像窗口 -->
    <el-dialog
      title="修改头像"
...
export default {
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      this.avatarName = new Date().getTime() + file.name;
    ...
    //       // await console.log(this.avatarUrl)
